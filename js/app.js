(() => {
    ...
    buttons.forEach((button => {
        button.addEventListener("click", (() => {
            buttons.forEach((btn => {
                btn.classList.remove("color-blue", "color-red", "color-purple");
            }));
            if (button.classList.contains("tabs__title_1")) button.classList.add("color-blue"); else if (button.classList.contains("tabs__title_2")) button.classList.add("color-red"); else if (button.classList.contains("tabs__title_3")) button.classList.add("color-purple");
        }));
    }));
